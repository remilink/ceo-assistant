...
Згадки про компанію в медіа й соцмережах: що з’явилось, загальний тон і що потребує реакції.

**Джерела:** <span class="rl-tag">пошта</span> <span class="rl-tag">веб</span>
...
??? note "Промпт — розгорнути та скопіювати"
    ...
    Джерела:
    - веб-пошук — основне джерело. Шукай згадки в новинних виданнях, галузевих медіа, блогах, а також у публічних соцмережах і на форумах (X/Twitter, LinkedIn, Facebook, Reddit, Telegram-канали, YouTube, профільні спільноти). Використовуй різні варіанти написання назви, назви продуктів та імена перших осіб.
    - Пошта (опційно, лише якщо підключено) — перевір, чи не надходили запити від журналістів, сповіщення про згадки (media alerts), розсилки моніторингу згадок або звернення, пов'язані з публічними згадками. Не відкривай і не чіпай нічого поза цим завданням.
