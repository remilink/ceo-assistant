...
Оберіть сценарій. Фільтруйте за джерелом, яке можна підключити.

<div class="rl-scen">
<div class="rl-filter">
<button class="rl-chip is-active" data-tag="">Всі</button>
<button class="rl-chip" data-tag="пошта">пошта</button>
<button class="rl-chip" data-tag="календар">календар</button>
<button class="rl-chip" data-tag="CRM">CRM</button>
<button class="rl-chip" data-tag="документи">документи</button>
<button class="rl-chip" data-tag="веб">веб</button>
</div>
<table>
<thead><tr><th>Сценарій</th><th>Опис</th><th>Що можна підключати</th></tr></thead>
<tbody>
<tr data-tags="пошта календар CRM"><td><a href="rankovyi-bryf/">☀️ Ранковий бриф CEO</a></td><td>Картина дня щоранку: важливе, ризики, кому написати.</td><td><span class="rl-tag">пошта</span> <span class="rl-tag">календар</span> <span class="rl-tag">CRM</span></td></tr>
...
<tr data-tags="пошта календар CRM документи"><td><a href="pidgotovka-do-zustrichi/">🤝 Підготовка до зустрічі</a></td><td>Контекст, питання й порядок денний до зустрічі.</td><td><span class="rl-tag">пошта</span> <span class="rl-tag">календар</span> <span class="rl-tag">CRM</span> <span class="rl-tag">документи</span></td></tr>
</tbody>
</table>
</div>
