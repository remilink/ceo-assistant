...
Попросіть самого асистента. Скажіть ChatGPT або Claude:

> Встанови скіли, перелічені на сторінці https://ceo-assistant.remilink.com/skills/, і надалі застосовуй їх за призначенням.

Асистент відкриє цю сторінку, знайде перелік і встановить кожен скіл. Далі він застосовуватиме їх сам, коли задача цього потребує. Нижче ті самі скіли з описом і командою для ручного встановлення.
